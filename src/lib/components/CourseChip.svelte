<script lang="ts">
	...
	let { planned, course, semesterId, issues, kind, onremove, onchoose, ontogglelock }: Props =
		$props();
...
<div
	bind:this={el}
	class="group relative rounded-md border border-l-4 px-2 py-1.5 text-sm shadow-sm transition {tone} {accent} chip-grab"
	draggable="true"
	role="button"
	tabindex="0"
